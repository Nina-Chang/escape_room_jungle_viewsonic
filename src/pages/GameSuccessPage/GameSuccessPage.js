...
export const GameSuccessPage = ({ navigateTo, backgroundImage,bgmAudio }) => {
  ...
  return (
    <div className="page-container" style={pageStyle}>
        <div className={GameSuccessPageStyle.explanationSection}>
            ...
            <img src='/images/object/jungle_escape_clue_frame.png' style={{transform:'scale(1.3,1)'}} alt="jungle_escape_clue_frame" loading="lazy"/>
            <div className={GameSuccessPageStyle.returnButton}>
                <img src='/images/object/jungle_escape_home_button.png' alt="jungle_escape_clue_frame" onClick={()=>navigateTo('start')} loading="lazy"/>
            </div>
        </div>
    </div>
  )
