    ...
    return (
        <div className="page-container" style={pageStyle}>
            <div className={MultipleChoiceClearPageStyle.explanationSection}>
                <div className={MultipleChoiceClearPageStyle.explanationTextFirstLine} style={{color:`${cfg.settings.themeForegroundColor}`}}>You found...</div>
                <div className={MultipleChoiceClearPageStyle.explanationTextSecondLine} style={{color:`${cfg.settings.themeForegroundColor}`}}>A Photo!</div>
