        ...
        <div className="page-container" style={pageStyle}>
            ...
            <div className={MultipleChoiceClearPageStyle.clueSection}>
                <button onClick={()=>setIsPicReveal(true)}>
                    {
                        isPicReveal?
                        <img src='/images/object/jungle_escape_photo02.png' alt="jungle_escape_photo02" loading="lazy"/>
                        :<img src='/images/object/jungle_escape_photo01.png' alt="jungle_escape_photo02" loading="lazy"/>
                    }
                </button>
                <img src='/images/object/jungle_escape_camera.png' alt="jungle_escape_camera" loading="lazy"/>
            </div>
