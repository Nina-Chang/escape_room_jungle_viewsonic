...
export const MultipleChoiceQuizPage = ({ navigateTo, backgroundImage,setWrongPathBackTo,currentProblemIndex,setCurrentProblemIndex }) => {
  ...
  return (
    <div className="page-container" style={pageStyle}>
        ...
        <div className={MultipleChoiceQuizPageStyle.questionIndexText} style={{color:`${cfg.settings.themeForegroundColor}`}}>
            {prevQuestionsCount+currentProblemIndex+1}/{totalProblemSum}
        </div>
        <div className={MultipleChoiceQuizPageStyle.questionText} style={{color:`${cfg.settings.themeForegroundColor}`}}>
